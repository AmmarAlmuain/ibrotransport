    ...
    <>
      <section className="-section -center">
        <div className="max-w-7xl max-lg:flex-col max-lg:mt-0 mt-20 flex gap-16 justify-between items-start">
          ...
          <div className="services-container flex flex-col gap-y-16">
            <div className="flex gap-x-16 max-md:flex-col max-md:gap-y-5">
              <div className="service-card flex justify-start max-sm:flex-col max-sm:gap-y-5 items-start w-full max-w-96 h-full">
