    ...
    <>
      <div className="w-full pt-20">
        <div className="p-20 bg-gray-100 flex max-sm:p-0 max-sm:pt-10 flex-col gap-10">
          ...
          <h1 className="-h1 max-sm:text-center">Google Map-Ansichtsfenster</h1>
          <iframe
            width="100%"
            height="600"
            frameBorder="0"
            ...
            marginHeight={0}
            marginWidth={0}
            src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=+(Linz%204020)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
          ></iframe>
        </div>
      </div>
    </>
